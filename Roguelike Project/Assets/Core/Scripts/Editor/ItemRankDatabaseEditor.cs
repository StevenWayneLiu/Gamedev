...
namespace CitrusCore.ItemSystem.Editor
{
    public partial class ItemRankDatabaseEditor : EditorWindow
    {
        ...
        const string DATABASE_PATH = @"Assets/Core/Scripts/ItemRankDatabase.asset";
        ...
        void OnEnable()
        {
            ...
            {
                if (!AssetDatabase.IsValidFolder("Assets/Core/Scripts"))
                {
                    AssetDatabase.CreateFolder("Assets/Core", "Scripts");
                }
