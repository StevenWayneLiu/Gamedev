...
public class SkillManager : MonoBehaviour {
    ...
    public Inventory skills = new Inventory();//holds skills that entity can use
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            if(other.GetComponentInChildren<CharacterManager>() != null)
            {
                ((Skill)skills[0]).targets.Add(other.GetComponentInChildren<CharacterManager>());
            }
        }
    }
