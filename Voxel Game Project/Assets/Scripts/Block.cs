...
public class Block {
    ...
    //returns meshdata for sides based on solidity of neighboring blocks
    public virtual MeshData BlocData(Chunk chunk, int x, int y, int z, MeshData meshData)
    {
    ...
    //add vertices for a side to the meshdata
